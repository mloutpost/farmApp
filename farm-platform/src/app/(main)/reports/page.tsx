    ...
    <div className="h-full overflow-y-auto">
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-semibold text-text-primary tracking-tight">Yield Reports</h1>
            <p className="mt-1 text-sm text-text-secondary">Harvest analytics, crop performance, and seasonal insights</p>
          </div>
          <button
        ...
        {/* Two-column layout: Top Nodes + Seasonal Comparison */}
